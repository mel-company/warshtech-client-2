...
export const ar = {
  ...
  maintenancePage: {
    ...
    subtitle: "السيارات القريبة أو المتأخرة عن موعد الصيانة",
    searchPlaceholder: "بحث بالسيارة، اللوحة، أو العميل...",
    empty: "لا توجد سيارات ضمن هذا الفلتر",
    emptyHint: "أكمل الفواتير مع قراءة العداد لبناء جدول الصيانة",
    count: "{count} سيارة",
    runScan: "توليد التنبيهات",
    scanDone: "تم إنشاء {count} تنبيه جديد",
    filters: {
      overdue: "متأخر",
      week: "هذا الأسبوع",
      month: "هذا الشهر",
